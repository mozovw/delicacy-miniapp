...
public class BeanUtils {
     ...
     * @return 映射类对象
     */
    public static  <E, T> List<E> mapList(Collection<T> data, Class<E> toClass) {
     ...
     * @return 映射类对象
     */
    public static  <E, T> List<E> mapList(Collection<T> data, Map<String, String> configMap, Class<E> toClass) {
